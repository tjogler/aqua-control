...
res=60
cwhite=lc.lightChannel(name="white",resolution=res,address=[0,5],sset="21:00",srise='9:00',maxIM=0.0,maxintens=0.55)
cblue1=lc.lightChannel(name='blue_1',resolution=res,address=1,sset='21:00',srise='9:00',maxIM=0.,maxintens=0.65)
cblue2=lc.lightChannel(name='blue_2',resolution=res,address=2,sset='21:00',srise='9:00',maxIM=0.03,mrise='20:40',mset='9:00',maxintens=0.65)
cred=lc.lightChannel(name="red",resolution=res,address=4,sset="20:00",srise='9:00',maxIM=0.0,maxintens=0.05)
cgreen=lc.lightChannel(name="green",resolution=res,address=3,sset="20:00",srise='9:00',maxIM=0.0,maxintens=0.0)
